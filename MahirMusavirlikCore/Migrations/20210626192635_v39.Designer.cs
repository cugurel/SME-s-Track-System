...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MahirMusavirlikCore.Models.KobiHizmet", b =>
                {
                    ...
                    b.Property<int>("ServiceSituationId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MahirMusavirlikCore.Models.ServiceSituation", b =>
                {
                    b.Property<int>("ServiceSiturationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ServiceSiturationId");

                    b.ToTable("ServiceSituations");
                });
            ...
            modelBuilder.Entity("MahirMusavirlikCore.Models.Sozlesme", b =>
                {
                    ...
                    b.Property<int>("SozlesmeSituationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SozlesmeSituationId");

                    b.ToTable("Sozlesmes");
                });

            modelBuilder.Entity("MahirMusavirlikCore.Models.SozlesmeSituation", b =>
                {
                    b.Property<int>("SozlesmeSituationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("SozlesmeSituationName")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("SozlesmeSituationId");

                    b.ToTable("SozlesmeSituations");
                });
            ...
            modelBuilder.Entity("MahirMusavirlikCore.Models.KobiHizmet", b =>
                {
                    ...
                    b.HasOne("MahirMusavirlikCore.Models.ServiceSituation", "ServiceSituation")
                        .WithMany()
                        .HasForeignKey("ServiceSituationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MahirMusavirlikCore.Models.Sozlesme", b =>
                {
                    ...
                    b.HasOne("MahirMusavirlikCore.Models.SozlesmeSituation", "SozlesmeSituation")
                        .WithMany()
                        .HasForeignKey("SozlesmeSituationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Kobi");

                    b.Navigation("SozlesmeSituation");
                });
